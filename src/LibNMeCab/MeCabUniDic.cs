...
namespace NMeCab
{
    ...
    public class MeCabUniDicTagger : MeCabTaggerBase<MeCabUniDicNode>
    {
        ...
        public static MeCabUniDicTagger Create(string dicDir, string[] userDic = null)
        {
            return Create(dicDir, userDic, () => new MeCabUniDicTagger());
        }
    ...
    public class MeCabUniDicNode : MeCabNodeBase<MeCabUniDicNode>
    {
        ...
        private string GetFeatureAt(int index)
        {
            ...
            if (this.features == null)
                this.features = StrUtils.SplitCsvRow(this.Feature, 26, 16);
